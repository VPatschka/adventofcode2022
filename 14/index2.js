...
const maxY = Math.max(...allCoordinates.map(({y}) => y)) + 2
...
do {
    ...
    do {
        ...
        if (!contains(sands, newSandPosition) && !contains(allPathes, newSandPosition) && newSandPosition.y < maxY) {
...
console.log(`Result: ${sands.length + 1}`)